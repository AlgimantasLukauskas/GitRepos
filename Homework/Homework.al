...
page 66100 "Internship Tasks Demo"
{
    PageType = Card;
    ApplicationArea = All;
    UsageCategory = Tasks;
    ...
    layout
    {
        area(Content)
        {
            group(Instructions)
            {
                ...
                field(Instruction1; 'Spauskite Action mygtuką norėdami paleisti užduočių demonstraciją')
                {
                    ApplicationArea = All;
                    Editable = false;
                    ShowCaption = false;
    ...
    actions
    {
        area(Processing)
        {
            ...
            {
                ApplicationArea = All;
                Caption = 'Paleisti 1 užduotį (Teksto apvertimas)';
                Image = Process;
            ...
            {
                ApplicationArea = All;
                Caption = 'Paleisti 2 užduotį (Min/Max)';
                Image = Process;
            ...
            {
                ApplicationArea = All;
                Caption = 'Paleisti 3 užduotį (Dublikatai)';
                Image = Process;
            ...
            {
                ApplicationArea = All;
                Caption = 'Paleisti 4 užduotį (Balsės/Priebalsės)';
                Image = Process;
